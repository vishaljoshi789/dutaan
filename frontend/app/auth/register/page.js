                    ...
                    <>
                      ...
                      <div className="md:col-span-5">
                        ...
                        <textarea
                          ...
                          defaultValue=""
                          placeholder="Your Store description Here..."
                          required
                        />
                      </div>
                      <div className="md:col-span-5">
                        ...
                        <input
                          ...
                          className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                          defaultValue=""
                          placeholder="Your GST Number Here..."
                          required
                        />
                      </div>
                      <div className="md:col-span-3">
                        <label htmlFor="aadhar">Aadhar Image</label>
                        <input
                          type="file"
                          name="aadhar"
                          id="aadhar"
                          className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                          defaultValue=""
                          placeholder="Your Aadhar Number Here..."
                          required
                        />
                      </div>
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          name="image"
                          id="image"
                          className="h-10 border mt-1 rounded px-4 p-2 w-full bg-gray-50"
                          required
                        />
                      </div>
                    </>
