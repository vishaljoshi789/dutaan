            ...
            <Carousel>
                <CarouselContent>
                    {productInfo.images&&productInfo.images.map((item)=>
                        <CarouselItem className='flex items-center justify-center w-fit'>
                            
                        <Image alt="product-img" height={0} width={0} sizes="100vw" className="lg:w-1/2 w-full lg:max-h-screen h-64 object-fill object-center rounded" src={`${baseURL}${item['image']}`} /></CarouselItem>
                    )}
