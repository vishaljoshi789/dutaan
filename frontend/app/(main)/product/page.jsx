                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 mt-6 lg:mt-0 p-5">
                        ...
                        <div className="flex flex-col justify-center">
                            <div className="flex gap-5">
                                ...
                                <span className="title-font font-medium text-2xl text-gray-900">₹{productInfo.price ? productInfo.price : productInfo.sell_price}</span>
                                <span className="title-font font-medium text-2xl text-red-500">-({parseInt((parseInt(productInfo.mrp) - parseInt(productInfo.price ? productInfo.price : productInfo.sell_price)) / (parseInt(productInfo.mrp) / 100))}%)</span>
                            </div>
                            <div className='flex items-center gap-10 mt-5'>
                                <button className="flex text-white bg-indigo-500 border-0 focus:outline-none hover:bg-indigo-600 rounded" ><Image src="/images/cart_add.png" onClick={addToCart} width={50} height={50} /></button>

                                <button onClick={toggleWishlist} className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                                    <svg fill={wishlist ? `#4F46E5` : `currentcolor`} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
