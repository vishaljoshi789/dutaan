...
export default function page() {
  let { userLogout, userInfo } = useContext(AuthContext);
  let loginCheck = () => {
    if (userInfo == null) {
      userLogout();
    }
  ...
  return (
    <PrivateRoute>
      {userInfo ? (
        <section className="text-gray-600 body-font bg-[#F5F5DC]">
              ...
              <div className="p-4 md:w-1/2">
                <div className="h-full border-2 border-black border-opacity-60 rounded-lg overflow-hidden p-5">
                  ...
                  <div className="p-6">
                    ...
                    <p className="leading-relaxed mb-3">
                      {userInfo.address.street_address}, {userInfo.address.city}
                    </p>
                  </div>
