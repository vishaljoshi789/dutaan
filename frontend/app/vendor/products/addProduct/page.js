                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="flex flex-wrap w-full gap-3 items-center md:justify-evenly">
                      {category.map((i) => <div key={i['id']} className='flex items-center gap-1 md:w-1/3'>
                        ...
                        <input className='categories' name={i['category']} onChange={categorytListSetter} value={i['category']} type='checkbox' />
                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="flex flex-wrap w-full gap-3 items-center md:justify-evenly">
                      {event.map((i) => <div key={i['id']} className='flex items-center gap-1 md:w-1/3'>
                        ...
                        <input className='events' name={i['event']} onChange={eventListSetter} value={i['event']} type='checkbox' />
                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="flex flex-col flex-wrap w-full gap-3 items-center rounded-sm">
                      {specsList.map((spec, index) =>
                        <div className="flex gap-1 items-center border-gray-300 border-2 rounded-sm px-1" key={index}>
                          <Input type="text" className="h-5 md:h-10 border rounded md:px-4 bg-gray-50  w-full md:w-auto" value={spec.name} placeholder="Label" onChange={(e) => handleSpecChange(index, "key", e.target.value)} />
                          ...
                          <button type='button' onClick={() => handleRemoveSpec(index)} className='h-auto w-20 md:w-7'>
                    ...
                    <div className="flex flex-col flex-wrap w-full gap-3 items-center md:justify-evenly rounded-sm">
                      ...
                      {imageList.map((image, index) =>
                        <div className="flex flex-col justify-center gap-1 items-center border-gray-300 border-2 rounded-sm " key={index}>
                          <Input type="file" className="h-10 border rounded bg-gray-50 w-full md:w-auto" placeholder="Image" onChange={(e) => handleImageChange(index, e.target.files[0])} />
