...
const EditProfile = () => {
  ...
  let getUser = async (e) => {
    let response = await api.get(`/admin/get-user-data?id=${id}`);
  ...
  let updateUser = async (e) => {
    e.preventDefault();
    let response = await api.post("/admin/update-user-data/", {
        ...
        <div className="h-[100vh] flex items-center">
          <div className="flex flex-col gap-5 w-full md:w-1/2 m-auto justify-center bg-[#F5f5dc] rounded-md p-10">
            ...
            >
              ...
              <Button
                type="submit"
                className="text-2xl w-fit bg-[#964B00] shadow-lg hover:shadow-sm hover:bg-[#422c16] cus-animate"
              >
                Update
              </Button>
            </form>
